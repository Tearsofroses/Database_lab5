...
SELECT 'Before INSERT:' AS Status, TotalAmount FROM Guest WHERE guestNo = 101;
INSERT INTO Booking (hotelNo, dateFrom, roomNo, guestNo, dateTo, NumOfAdult)
VALUES (1, '2025-03-10', 2, 101, '2025-03-13', 1);  -- 3 days * 120 = 360
SELECT 'After INSERT:' AS Status, TotalAmount FROM Guest WHERE guestNo = 101;
...
SELECT '=== Test 5: UPDATE booking guest (transfer to guest 102) ===' AS Test;
SELECT 'Guest 101 before:' AS Status, TotalAmount FROM Guest WHERE guestNo = 101;
SELECT 'Guest 102 before:' AS Status, TotalAmount FROM Guest WHERE guestNo = 102;
UPDATE Booking 
SET guestNo = 102
WHERE hotelNo = 1 AND dateFrom = '2025-03-10' AND roomNo = 2;
SELECT 'Guest 101 after:' AS Status, TotalAmount FROM Guest WHERE guestNo = 101;
SELECT 'Guest 102 after:' AS Status, TotalAmount FROM Guest WHERE guestNo = 102;
-- Expected: Guest 101 = 0, Guest 102 = 840
