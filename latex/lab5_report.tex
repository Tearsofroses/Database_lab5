...
\hline
1 & Test Hotel & London & 101 & double & 150.00 \\
1 & Test Hotel & London & 103 & single & 50.00 \\
\hline
\end{tabular}
\end{center}

\begin{lstlisting}
-- Use procedure to insert via the view
CALL InsertIntoLondonHotelRoom(2, 'Grand Hotel', 301, 'double', 200.00);

-- Verify the insert
SELECT * FROM LondonHotelRoom WHERE hotelNo = 2;
\end{lstlisting}
...
\textbf{hotelNo} & \textbf{hotelName} & \textbf{city} & \textbf{roomNo} & \textbf{type} & \textbf{price} \\
\hline
2 & Grand Hotel & London & 301 & double & 200.00 \\
\hline
\end{tabular}
\end{center}
