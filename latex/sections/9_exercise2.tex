...
Test 5 & UPDATE double room 150 to 200 & Success \\
Test 6 & UPDATE double room to 90 & Error - constraint violation \\
\hline
\end{tabular}
\end{center}
...
Test 5 & UPDATE double room to 85 & Error - 85 $\leq$ 90 \\
Test 6 & UPDATE double room to 120 & Success (120 $>$ 90) \\
\hline
\end{tabular}
\end{center}
...
Test 5 & UPDATE to create overlap & Error - overlap detected \\
Test 6 & UPDATE without overlap & Success \\
\hline
\end{tabular}
\end{center}
...
Test 5 & UPDATE to 2 adults & Success \\
Test 6 & UPDATE to 5 adults & Error - exceeds capacity \\
\hline
\end{tabular}
\end{center}
...
Test 2 & INSERT 3-day booking & TotalAmount +360 (total 760) \\
Test 3 & DELETE first booking & TotalAmount -400 (total 360) \\
Test 4 & UPDATE dates (3 to 7 days) & TotalAmount 360$\rightarrow$840 \\
Test 5 & UPDATE guest transfer & Guest 101: 0, Guest 102: 840 \\
\hline
\end{tabular}
\end{center}
